...
print("Write a Pandas program to select the rows the score is between 15 and 20 (inclusive).\n\n")
...
print("Write a Pandas program to add a column named \"column1\" in the sixth position of the \"coalpublic2013.xlsx\" excel sheet and fill it with NaN values.\n\n")
...
print("Write a Pandas program to import given excel data (coalpublic2013.xlsx ) into a dataframe and find details where \"Mine Name\" starts with \"P\"\n\n")
...
print("Write a Pandas program to import given excel data (employee.xlsx ) into a Pandas dataframe and find a list of employees where hire_date> 01-01-07.\n\n")
...
print("Find the most expensive car company name")
max_=data.price.max()
